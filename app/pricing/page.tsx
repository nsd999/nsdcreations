  ...
  return (
    <div className="flex-1 flex flex-col relative overflow-x-hidden">
      ...
      <section className="pt-24 pb-16 px-6 max-w-7xl mx-auto w-full text-center">
        <ScrollReveal direction="up" className="max-w-xl mx-auto flex flex-col space-y-3">
      ...
      <section className="py-12 px-6 max-w-7xl mx-auto w-full grid grid-cols-1 md:grid-cols-3 gap-8">
        {plans.map((plan, index) => (
          <ScrollReveal key={plan.name} delay={index * 0.1} direction="up" className="h-full">
            <div
              className={`p-8 rounded-3xl bg-white dark:bg-[#09090b] border shadow-sm flex flex-col justify-between relative overflow-hidden h-full ${
                plan.highlight
      ...
      <section className="py-12 px-6 max-w-4xl mx-auto w-full text-center text-xs text-zinc-500 dark:text-zinc-400">
        <ScrollReveal direction="up" className="p-6 rounded-2xl bg-zinc-50/50 dark:bg-[#09090b]/40 border border-zinc-200/50 dark:border-zinc-900/50 flex flex-col sm:flex-row items-center justify-between gap-4">
